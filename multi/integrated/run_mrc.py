...
from multi.integrated.model import ElectraForQuestionAnswering_v2 as ElectraForQuestionAnswering
from multi.integrated.utils import init_logger, set_seed
from transformers import ElectraTokenizer, ElectraConfig

from multi.integrated.main_functions import train, evaluate, only_scoring
...
if __name__ == '__main__':
    ...
    cli_parser.add_argument("--scoring", type=bool, default=True)
