...
from single.integrated.processor import SquadResult
from single.integrated.squad_metric import (
    compute_predictions_logits
)
from single.integrated.utils import load_examples, set_seed, to_list
...
from single.integrated.multi_measure import evaluate_prediction_file
...
def evaluate(args, model, tokenizer, prefix="", global_step=None, all_predict=False, logger=None):
    ...
    for batch in progress_bar(eval_dataloader):
        ...
        for i, feature_index in enumerate(feature_indices):
            ...
            long_start_logits, long_end_logits, short_start_logits, short_end_logits = [to_list(output[i]) for output in outputs]
            result = SquadResult(unique_id, long_start_logits, long_end_logits, short_start_logits, short_end_logits)
