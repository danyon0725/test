...
from single.long.model import ElectraForQuestionAnswering
from single.long.utils import init_logger, set_seed
from transformers import ElectraTokenizer, ElectraConfig

from single.long.main_functions import train, evaluate, only_scoring
