...
from single.short.model import ElectraForQuestionAnswering
from single.short.utils import init_logger, set_seed
from transformers import ElectraTokenizer, ElectraConfig

from single.short.main_functions import train, evaluate, only_scoring
...
if __name__ == '__main__':
    ...
    # cli_parser.add_argument("--train_file_path", type=str, default="../../data/refine_sample.json")
    ...
    cli_parser.add_argument("--train_batch_size", type=int, default=2)
    cli_parser.add_argument("--eval_batch_size", type=int, default=2)
